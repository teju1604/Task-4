...
root.configure(background="#073B3A")
...
user_label = Label(root, image=scissor_img, bg="#073B3A")
comp_label = Label(root, image=scissor_img_comp, bg="#073B3A")
comp_label.grid(row=1, column=0)
user_label.grid(row=1, column=4)

playerScore = Label(root, text=0, font=100, bg="#073B3A", fg="white")
computerScore = Label(root, text=0, font=100, bg="#073B3A", fg="white")
computerScore.grid(row=1, column=1)
playerScore.grid(row=1, column=3)

user_indicator = Label(root, font=50, text="USER", bg="#073B3A", fg="white")
comp_indicator = Label(root, font=50, text="COMPUTER",
                       bg="#073B3A", fg="white")
user_indicator.grid(row=0, column=3)
comp_indicator.grid(row=0, column=1)

msg = Label(root, font=50, bg="#073B3A", fg="white")
